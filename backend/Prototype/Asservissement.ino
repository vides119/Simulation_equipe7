...
void setup() {
  ...
  pinMode(12, OUTPUT);
  pinMode(13, OUTPUT);
  TCCR1A = 0b10101011; //COM1A1 COM1A0 COM1B1 COM1B0 COM1C1 COM1C0 WGM11 WGM10
  TCCR1B = 0b11101001; //ICNC1 ICES1 - WGM13 WGM12 CS12 CS11 CS10
...
void update_command()
{
  ...
  Serial.print(temps);Serial.print(",");Serial.print(consigne);Serial.print(",");Serial.print(commande);Serial.print(",");Serial.print(t0);Serial.print(",");Serial.print(t1);Serial.print(",");Serial.print(t2);Serial.print(",");Serial.println(pred_t2);
}
...
void asservissement_loop()
{
  ...
  //Serial.print(commande);Serial.print(",");Serial.print(t0);Serial.print(",");Serial.print(t1);Serial.print(",");Serial.print(t2);Serial.print(",");Serial.println(t3);
}
